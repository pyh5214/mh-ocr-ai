            ...
            <div className="content-stretch flex items-center justify-between px-[24px] relative size-full">
              <div className="content-stretch flex gap-[40px] h-full items-center relative shrink-0">
                ...
                <nav className="content-stretch flex gap-[32px] h-full items-center relative shrink-0">
                  <a href="/file-management" className="border-[#137fec] border-b-2 border-solid content-stretch flex h-full items-center px-[4px] font-bold text-[#137fec] text-[14px]">파일 관리</a>
                  <a href="/analytics" className="border-[rgba(0,0,0,0)] border-b-2 border-solid content-stretch flex h-full items-center px-[4px] font-bold text-[#64748b] text-[14px]">통계</a>
                  <a href="/settings" className="border-[rgba(0,0,0,0)] border-b-2 border-solid content-stretch flex h-full items-center px-[4px] font-bold text-[#64748b] text-[14px]">세팅</a>
                </nav>
              </div>
